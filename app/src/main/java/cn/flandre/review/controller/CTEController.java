...
public class CTEController extends Controller {
    ...
    public void init(Word word) {
        ...
        controller.getWord().setVisibility(View.INVISIBLE);
        controller.getAccent().setVisibility(View.INVISIBLE);
    ...
    private void setUI(boolean clickJudge){
        if (clickJudge){
            ...
            controller.getWord().setVisibility(View.VISIBLE);
            controller.getAccent().setVisibility(View.VISIBLE);
        }
    }
